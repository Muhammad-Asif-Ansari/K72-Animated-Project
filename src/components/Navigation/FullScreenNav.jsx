...
const FullScreenNav = () => {
    ...
    return (
        <div ref={fullScreenRef} id='fullScreenNav' className='h-screen text-white z-50 overflow-hidden w-full absolute'>
            <div className='h-screen w-full fixed '>
                 <div className='h-full w-full flex '>
                    <div className='stairSlide h-full w-1/5 bg-red-900'></div>
                    <div className='stairSlide h-full w-1/5 bg-red-900'></div>
                    <div className='stairSlide h-full w-1/5 bg-red-900'></div>
                    <div className='stairSlide h-full w-1/5 bg-red-900'></div>
                    <div className='stairSlide h-full w-1/5 bg-red-900'></div>
